...
Example for ESP8266-12F/Wemos D1-R2-mini
...
Yellow DS  - to GPIO 5 (R2 4.7k - 2.0k to +3.3V, depending on length of the cable)
Green 2N   - to GPIO 4 (via R1 (10k - 2.0k, depending on length of the cable)
Red        - to +3.3V
Black      - to GND
...
OneWire  ds(5);  // 1-Wire to GPIO5/D1
